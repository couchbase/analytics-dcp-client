...
public class Client {
    ...
    public Client(ClientBuilder builder) {
        ...
        env = ClientEnvironment.builder().setConnectionNameGenerator(builder.connectionNameGenerator())
                ...
                .setBootstrapTimeout(builder.bootstrapTimeout()).setSocketConnectTimeout(builder.socketConnectTimeout())
                ...
                .setClusterAt(builder.hostnames(), builder.connectionString())
